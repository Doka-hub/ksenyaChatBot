...
def migrate_forward(op, old_orm, new_orm):
    op.create_table(new_orm.notificationbutton)
    op.create_table(new_orm.notificationimage)
    op.run_data_migration()


def migrate_backward(op, old_orm, new_orm):
    op.run_data_migration()
    op.drop_table(old_orm.notificationimage)
    op.drop_table(old_orm.notificationbutton)
